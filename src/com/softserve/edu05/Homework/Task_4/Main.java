...
public class Main {
    public static void main(String[] args) {
        ...
        Car car_1 = new Car("BMW", 2008, 1.8f);
        Car car_2 = new Car("Audi", 2021, 4.4f);
        Car car_3 = new Car("Mercedes", 2015, 3.6f);
        Car car_4 = new Car("Porsche", 2023, 5.0f);

        Car cars[] = {car_1, car_2, car_3, car_4};

        System.out.print("Enter the graduation year: ");
        int grad_year = scan.nextInt();
        boolean isYear = false;

        for(int i = 0; i < cars.length; i++){
            if(grad_year == cars[i].getYear()) {
